...
const downloadingItems = ref<Download[]>([
  {
    id: 1,
...
<div class="downloading">
  ...
  <template v-else>
    <div class="control-bar">
      ...
      <el-button type="primary" size="small">全部开始</el-button>
      <el-button type="warning" size="small">全部暂停</el-button>
      ...
      <el-scrollbar>
        ...
        >
          ...
          <el-table-column property="total_size" label="文件大小" >
            <template #default="scope">{{Math.round(scope.row.downloaded_size / (1024 * 1024))}}MB/{{Math.round(scope.row.total_size / (1024 * 1024))}}MB</template>
          </el-table-column>
